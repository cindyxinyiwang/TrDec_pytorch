...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s0" \
  ...
  --merge_bpe \
  --poly_norm_m=3.5 \
  --out_file="beam40_m3.5" \
  --cuda \
  "$@"

python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s1" \
  --data_path="/projects/tir2/users/xinyiw1/loreili/orm-eng/data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.word.eng" \
  --target_tree_vocab="vocab.rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s2" \
  --data_path="/projects/tir2/users/xinyiw1/loreili/orm-eng/data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.word.eng" \
  --target_tree_vocab="vocab.rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s3" \
  --data_path="/projects/tir2/users/xinyiw1/loreili/orm-eng/data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.word.eng" \
  --target_tree_vocab="vocab.rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s4" \
  --data_path="/projects/tir2/users/xinyiw1/loreili/orm-eng/data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.word.eng" \
  --target_tree_vocab="vocab.rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_eng_trdec_v7_s5" \
  --data_path="/projects/tir2/users/xinyiw1/loreili/orm-eng/data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.word.eng" \
  --target_tree_vocab="vocab.rule.eng" \
