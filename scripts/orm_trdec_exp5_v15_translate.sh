...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s5" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s1" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.bina_word.eng" \
  --target_tree_vocab="vocab.bina_rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s2" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.bina_word.eng" \
  --target_tree_vocab="vocab.bina_rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s3" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.bina_word.eng" \
  --target_tree_vocab="vocab.bina_rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s4" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.bina_word.eng" \
  --target_tree_vocab="vocab.bina_rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v15_s0" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.bina_word.eng" \
  --target_tree_vocab="vocab.bina_rule.eng" \
