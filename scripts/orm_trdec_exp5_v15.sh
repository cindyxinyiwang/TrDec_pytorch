...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
  ...
  --target_tree_train="set0-trainunfilt.tok.eng.bina" \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v15_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
