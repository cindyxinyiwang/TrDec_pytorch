...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
  ...
  --target_tree_train="set0-trainunfilt.tok.eng.tri" \
  --target_tree_valid="set0-dev.tok.eng.tri" \
...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --no_lhs \
  --pos=1 \
  --output_dir="outputs_orm_trdec_exp5_v12_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
