...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --pos=1 \
  --share_emb_softmax \
  --output_dir="outputs_orm_trdec_exp5_v5_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
