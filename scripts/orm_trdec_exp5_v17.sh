...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --parent_feed=0 \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v17_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
