...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --single_attn \
  --single_readout \
  --output_dir="outputs_orm_trdec_exp5_v16_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
