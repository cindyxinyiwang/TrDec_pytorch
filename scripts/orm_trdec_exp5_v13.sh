...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python3.6 src/main.py \
  ...
  --parent_feed=0 \
  --rule_parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v13_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
