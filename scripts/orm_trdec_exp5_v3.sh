...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --single_readout \
  --single_attn \
  --output_dir="outputs_orm_trdec_exp5_v3_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
