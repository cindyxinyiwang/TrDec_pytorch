...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s0" \
...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s1" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.tri_word.eng" \
  --target_tree_vocab="vocab.tri_rule.eng" \
...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s2" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.tri_word.eng" \
  --target_tree_vocab="vocab.tri_rule.eng" \
...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s3" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.tri_word.eng" \
  --target_tree_vocab="vocab.tri_rule.eng" \
...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s4" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.tri_word.eng" \
  --target_tree_vocab="vocab.tri_rule.eng" \
...
python3.6 src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v12_s5" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.tri_word.eng" \
  --target_tree_vocab="vocab.tri_rule.eng" \
