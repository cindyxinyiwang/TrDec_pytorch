...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  ...
  --rule_parent_feed=0 \
  --parent_feed=0 \
  --output_dir="outputs_orm_trdec_exp5_v18_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
