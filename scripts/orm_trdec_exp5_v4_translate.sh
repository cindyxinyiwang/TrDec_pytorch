...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v4_s1" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v4_s2" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.pos-no-lhs-word.eng" \
  --target_tree_vocab="vocab.pos-no-lhs-rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v4_s3" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.pos-no-lhs-word.eng" \
  --target_tree_vocab="vocab.pos-no-lhs-rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v4_s4" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.pos-no-lhs-word.eng" \
  --target_tree_vocab="vocab.pos-no-lhs-rule.eng" \
...
python src/translate.py \
  --trdec \
  --model_dir="outputs_orm_trdec_exp5_v4_s5" \
  --data_path="data/orm_data/" \
  --source_vocab="vocab.orm" \
  --target_word_vocab="vocab.pos-no-lhs-word.eng" \
  --target_tree_vocab="vocab.pos-no-lhs-rule.eng" \
