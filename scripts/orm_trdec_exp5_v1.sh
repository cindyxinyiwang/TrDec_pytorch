...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s0" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
  ...
  --target_tree_vocab="vocab.no-lhs-rule.eng" \
  --target_word_vocab="vocab.no-lhs-word.eng" \
...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s1" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s2" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s3" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s4" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
...
python src/main.py \
  --trdec \
  --no_lhs \
  --output_dir="outputs_orm_trdec_exp5_v1_s5" \
  --log_every=10 \
  --eval_every=200 \
  --reset_output_dir \
  --d_word_vec=512 \
